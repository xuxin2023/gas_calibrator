...
_FIELD_LABELS = {
    ...
    "measured_value_source": "测量值来源",
    "co2_steady_window_found": "气路稳态窗命中",
    "co2_steady_window_status": "气路稳态窗结果",
    "co2_steady_window_reason": "气路稳态窗原因",
    "co2_steady_window_analyzer_source": "气路稳态窗分析仪来源",
    "co2_steady_window_value_key": "气路稳态窗值字段",
    "co2_steady_window_candidate_count": "气路稳态窗候选数",
    "co2_steady_window_start_sample_index": "气路稳态窗起始样本行",
    "co2_steady_window_end_sample_index": "气路稳态窗结束样本行",
    "co2_steady_window_start_ts": "气路稳态窗开始时间",
    "co2_steady_window_end_ts": "气路稳态窗结束时间",
    "co2_steady_window_sample_count": "气路稳态窗样本数",
    "co2_steady_window_mean_ppm": "气路稳态窗平均值(ppm)",
    "co2_steady_window_std_ppm": "气路稳态窗标准差(ppm)",
    "co2_steady_window_range_ppm": "气路稳态窗极差(ppm)",
    "co2_steady_window_slope_ppm_per_s": "气路稳态窗斜率(ppm/s)",
    "co2_bad_frame": "气路坏帧",
    "co2_bad_frame_reason": "气路坏帧原因",
    "co2_soft_warn": "气路软警告帧",
    "co2_soft_warn_reason": "气路软警告原因",
    "co2_phase_label": "气路采样相位",
    "co2_phase_reason": "气路采样相位原因",
    "co2_source_candidate": "气路候选来源",
    "co2_source_selected_for_value": "气路代表值选用来源",
    "co2_bad_frame_count": "气路坏帧数",
    "co2_bad_frame_ratio": "气路坏帧占比",
    "co2_soft_warn_count": "气路软警告帧数",
    "co2_soft_warn_ratio": "气路软警告帧占比",
    "co2_phase_excluded_count": "气路相位排除样本数",
    "co2_phase_excluded_ratio": "气路相位排除样本占比",
    "co2_phase_reason_summary": "气路相位排除摘要",
    "co2_phase_contract_reason": "气路采样契约降级原因",
    "co2_candidate_rows_before_phase_gate": "气路相位门禁前候选样本数",
    "co2_candidate_rows_after_phase_gate": "气路相位门禁后候选样本数",
    "co2_candidate_rows_before_segment_gate": "气路分段门禁前候选样本数",
    "co2_candidate_rows_after_segment_gate": "气路分段门禁后候选样本数",
    "co2_candidate_rows_after_quarantine": "气路隔离后候选样本数",
    "co2_source_segment_id": "气路来源分段ID",
    "co2_source_segment_selected": "气路选用来源分段",
    "co2_source_segment_rows": "气路来源分段样本数",
    "co2_source_segment_settle_excluded": "气路来源分段排除样本",
    "co2_source_segment_reason": "气路来源分段原因",
    "co2_source_segment_settle_excluded_count": "气路来源分段排除数",
    "co2_source_segment_settle_excluded_ratio": "气路来源分段排除占比",
    "co2_source_segment_reason_summary": "气路来源分段摘要",
    "co2_source_segment_contract_reason": "气路来源分段契约降级原因",
    "co2_temporal_excluded": "气路时间契约排除样本",
    "co2_temporal_reason": "气路时间契约原因",
    "co2_timestamp_monotonic": "气路时间戳单调",
    "co2_duplicate_timestamp_count": "气路重复时间戳数",
    "co2_backward_timestamp_count": "气路回退时间戳数",
    "co2_large_gap_count": "气路大间隙数",
    "co2_temporal_candidate_rows_before_gate": "气路时间门禁前候选样本数",
    "co2_temporal_candidate_rows_after_gate": "气路时间门禁后候选样本数",
    "co2_effective_dwell_seconds": "气路有效驻留时间s",
    "co2_nominal_dt_seconds": "气路标称采样间隔s",
    "co2_cadence_coverage_ratio": "气路节奏覆盖率",
    "co2_temporal_contract_status": "气路时间契约结果",
    "co2_temporal_contract_reason": "气路时间契约原因",
    "co2_temporal_fallback_reason": "气路时间契约降级原因",
    "co2_rows_before_quarantine": "气路隔离前样本数",
    "co2_rows_after_quarantine": "气路隔离后样本数",
    "co2_source_selected": "气路选中来源",
    "co2_source_candidates": "气路候选来源摘要",
    "co2_source_switch_reason": "气路来源切换原因",
    "co2_source_trust_reason": "气路来源可信度说明",
    "co2_quarantine_reason_summary": "气路坏帧隔离摘要",
    "co2_decision_waterfall_status": "气路决策瀑布结果",
    "co2_decision_waterfall_reason": "气路决策瀑布原因",
    "co2_decision_stage_count": "气路决策阶段数",
    "co2_decision_selected_stage_path": "气路决策阶段路径",
    "co2_decision_stage_summary": "气路决策阶段摘要",
    "co2_point_suitability_status": "气路点适用性",
    "co2_calibration_candidate_status": "气路校准候选状态",
    "co2_calibration_candidate_recommended": "气路校准候选推荐",
    "co2_calibration_candidate_hard_blocked": "气路校准候选硬阻断",
    "co2_calibration_weight_recommended": "气路推荐校准权重",
    "co2_calibration_weight_reason": "气路校准权重原因",
    "co2_calibration_reason_chain": "气路校准原因链",
    "co2_evidence_score": "气路证据分",
    "co2_point_evidence_budget_reason": "气路证据预算原因",
    "co2_point_evidence_budget_summary": "气路证据预算摘要",
    "co2_point_suitability_reason_chain": "气路点适用性原因链",
...
_COMMON_SHEET_FIELDS = [
    ...
    "co2_phase_label",
    "co2_phase_reason",
    "co2_source_candidate",
    "co2_source_selected_for_value",
    "co2_bad_frame_count",
    "co2_bad_frame_ratio",
    "co2_soft_warn_count",
    "co2_soft_warn_ratio",
    ...
    "co2_source_segment_settle_excluded",
    ...
    "co2_calibration_candidate_status",
