...
def _base_config() -> dict:
    return {
        ...
        "devices": {
            ...
            "thermometer": {"enabled": True, "port": "COM18", "baud": 2400},
            "relay": {"enabled": True, "port": "COM20", "baud": 38400},
            "relay_8": {"enabled": True, "port": "COM21", "baud": 38400},
            "dewpoint_meter": {"enabled": False, "port": "COM17", "baud": 9600},
            "humidity_generator": {"enabled": False, "port": "COM16", "baud": 9600},
            "gas_analyzers": [
