...
def export_run_offline_artifacts(
    *,
    ...
    recognition_readiness_roles = {
        ...
        "route_specific_validation_matrix": "execution_summary",
        "validation_run_set": "execution_summary",
        "verification_digest": "diagnostic_analysis",
        "verification_rollup": "diagnostic_analysis",
...
def build_suite_case_metadata(case: dict[str, Any], *, suite_name: str) -> dict[str, Any]:
    ...
    if kind == "scenario":
        ...
        "ec_dynamic",
        "ec_system_id",
        "ga_dynamic_uncertainty",
        "ga_operating_envelope",
        "ga_bench_readiness",
        "ga_certificate_admission",
    }:
    ...
    elif kind == "ga_dynamic_uncertainty":
        failure_type = "gas_analyzer_dynamic_uncertainty"
    elif kind == "ga_operating_envelope":
    ...
    elif kind == "ga_certificate_admission":
        failure_type = "gas_analyzer_certificate_operational_admission"
    return {
        "suite": suite_name,
