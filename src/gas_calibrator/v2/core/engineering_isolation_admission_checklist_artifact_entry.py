...
def build_engineering_isolation_admission_checklist_artifact_entry(
    *,
    artifact_path: Any,
    ...
    return {
        ...
        "artifact_key": ENGINEERING_ISOLATION_ADMISSION_CHECKLIST_ARTIFACT_KEY,
        "artifact_type": str(
            manifest_payload.get("artifact_type")
            or ENGINEERING_ISOLATION_ADMISSION_CHECKLIST_ARTIFACT_KEY
        ),
        "reviewer_artifact_key": ENGINEERING_ISOLATION_ADMISSION_CHECKLIST_REVIEWER_ARTIFACT_KEY,
        "reviewer_artifact_type": str(
            reviewer_manifest_payload.get("artifact_type")
            or ENGINEERING_ISOLATION_ADMISSION_CHECKLIST_REVIEWER_ARTIFACT_KEY
        ),
