...
DEFAULT_ROLE_CATALOG: dict[str, list[str]] = {
    ...
    "execution_summary": [
        ...
        "run_artifact_index",
        "run_artifact_index_markdown",
        "reindex_manifest",
        "reindex_manifest_markdown",
    ...
    "formal_analysis": [
        ...
        "route_specific_validation_matrix_markdown",
        "validation_run_set_markdown",
        "software_validation_traceability_matrix_markdown",
        "requirement_design_code_test_links_markdown",
        "validation_evidence_index_markdown",
        "change_impact_summary_markdown",
        "rollback_readiness_summary_markdown",
        "release_manifest_markdown",
        "release_scope_summary_markdown",
        "release_boundary_digest_markdown",
        "release_evidence_pack_index_markdown",
...
KNOWN_ARTIFACT_KEYS_BY_FILENAME: dict[str, str] = {
    ...
    "run_artifact_index.json": "run_artifact_index",
    "run_artifact_index.md": "run_artifact_index_markdown",
    "artifact_contract_catalog.json": "artifact_contract_catalog",
    "artifact_contract_catalog.md": "artifact_contract_catalog_markdown",
    "compatibility_scan_summary.json": "compatibility_scan_summary",
    "compatibility_scan_summary.md": "compatibility_scan_summary_markdown",
    "reindex_manifest.json": "reindex_manifest",
    "reindex_manifest.md": "reindex_manifest_markdown",
    ...
    "certificate_lifecycle_summary.json": "certificate_lifecycle_summary",
    "certificate_lifecycle_summary.md": "certificate_lifecycle_summary_markdown",
    ...
    "pre_run_readiness_gate.json": "pre_run_readiness_gate",
    "pre_run_readiness_gate.md": "pre_run_readiness_gate_markdown",
    ...
    "uncertainty_model.json": "uncertainty_model",
    "uncertainty_model.md": "uncertainty_model_markdown",
    "uncertainty_input_set.json": "uncertainty_input_set",
    "uncertainty_input_set.md": "uncertainty_input_set_markdown",
    "sensitivity_coefficient_set.json": "sensitivity_coefficient_set",
    "sensitivity_coefficient_set.md": "sensitivity_coefficient_set_markdown",
    "budget_case.json": "budget_case",
    "budget_case.md": "budget_case_markdown",
    "uncertainty_golden_cases.json": "uncertainty_golden_cases",
    "uncertainty_golden_cases.md": "uncertainty_golden_cases_markdown",
    "uncertainty_report_pack.json": "uncertainty_report_pack",
    "uncertainty_report_pack.md": "uncertainty_report_pack_markdown",
    "uncertainty_digest.json": "uncertainty_digest",
    "uncertainty_digest.md": "uncertainty_digest_markdown",
    "uncertainty_rollup.json": "uncertainty_rollup",
    "uncertainty_rollup.md": "uncertainty_rollup_markdown",
    ...
    "route_specific_validation_matrix.json": "route_specific_validation_matrix",
    "route_specific_validation_matrix.md": "route_specific_validation_matrix_markdown",
    "validation_run_set.json": "validation_run_set",
    "validation_run_set.md": "validation_run_set_markdown",
    "verification_digest.json": "verification_digest",
    "verification_digest.md": "verification_digest_markdown",
    "verification_rollup.json": "verification_rollup",
    "verification_rollup.md": "verification_rollup_markdown",
    ...
    "requirement_design_code_test_links.json": "requirement_design_code_test_links",
    "requirement_design_code_test_links.md": "requirement_design_code_test_links_markdown",
    "validation_evidence_index.json": "validation_evidence_index",
    "validation_evidence_index.md": "validation_evidence_index_markdown",
    "change_impact_summary.json": "change_impact_summary",
    "change_impact_summary.md": "change_impact_summary_markdown",
    "rollback_readiness_summary.json": "rollback_readiness_summary",
    "rollback_readiness_summary.md": "rollback_readiness_summary_markdown",
    "artifact_hash_registry.json": "artifact_hash_registry",
    "artifact_hash_registry.md": "artifact_hash_registry_markdown",
    "audit_event_store.json": "audit_event_store",
    "audit_event_store.md": "audit_event_store_markdown",
    "environment_fingerprint.json": "environment_fingerprint",
    "environment_fingerprint.md": "environment_fingerprint_markdown",
    "config_fingerprint.json": "config_fingerprint",
    "config_fingerprint.md": "config_fingerprint_markdown",
    "release_input_digest.json": "release_input_digest",
    "release_input_digest.md": "release_input_digest_markdown",
    "release_manifest.json": "release_manifest",
    "release_manifest.md": "release_manifest_markdown",
    "release_scope_summary.json": "release_scope_summary",
    "release_scope_summary.md": "release_scope_summary_markdown",
    "release_boundary_digest.json": "release_boundary_digest",
    "release_boundary_digest.md": "release_boundary_digest_markdown",
    "release_evidence_pack_index.json": "release_evidence_pack_index",
    "release_evidence_pack_index.md": "release_evidence_pack_index_markdown",
    ...
    "pt_ilc_registry.json": "pt_ilc_registry",
    "pt_ilc_registry.md": "pt_ilc_registry_markdown",
    "external_comparison_importer.json": "external_comparison_importer",
    "external_comparison_importer.md": "external_comparison_importer_markdown",
    "comparison_evidence_pack.json": "comparison_evidence_pack",
    "comparison_evidence_pack.md": "comparison_evidence_pack_markdown",
    "scope_comparison_view.json": "scope_comparison_view",
    "scope_comparison_view.md": "scope_comparison_view_markdown",
    "comparison_digest.json": "comparison_digest",
    "comparison_digest.md": "comparison_digest_markdown",
    "comparison_rollup.json": "comparison_rollup",
...
KNOWN_REPORT_ARTIFACTS = [
    ...
    "run_artifact_index.md",
    "artifact_contract_catalog.json",
    "artifact_contract_catalog.md",
    "compatibility_scan_summary.json",
    "compatibility_scan_summary.md",
    "reindex_manifest.json",
    "reindex_manifest.md",
    ...
    "certificate_lifecycle_summary.md",
    "certificate_readiness_summary.json",
    "certificate_readiness_summary.md",
    "pre_run_readiness_gate.json",
    "pre_run_readiness_gate.md",
    "metrology_traceability_stub.json",
    "metrology_traceability_stub.md",
    "uncertainty_model.json",
    "uncertainty_model.md",
    "uncertainty_input_set.json",
    "uncertainty_input_set.md",
    "sensitivity_coefficient_set.json",
    "sensitivity_coefficient_set.md",
    "budget_case.json",
    "budget_case.md",
    "uncertainty_golden_cases.json",
    "uncertainty_golden_cases.md",
    "uncertainty_report_pack.json",
    "uncertainty_report_pack.md",
    "uncertainty_digest.json",
    "uncertainty_digest.md",
    "uncertainty_rollup.json",
    "uncertainty_rollup.md",
    ...
    "route_specific_validation_matrix.md",
    "validation_run_set.json",
    "validation_run_set.md",
    "verification_digest.json",
    "verification_digest.md",
    "verification_rollup.json",
    "verification_rollup.md",
    ...
    "requirement_design_code_test_links.md",
    "validation_evidence_index.json",
    "validation_evidence_index.md",
    "change_impact_summary.json",
    "change_impact_summary.md",
    "rollback_readiness_summary.json",
    "rollback_readiness_summary.md",
    "artifact_hash_registry.json",
    "artifact_hash_registry.md",
    "audit_event_store.json",
    "audit_event_store.md",
    "environment_fingerprint.json",
    "environment_fingerprint.md",
    "config_fingerprint.json",
    "config_fingerprint.md",
    "release_input_digest.json",
    "release_input_digest.md",
    "release_manifest.json",
    "release_manifest.md",
    "release_scope_summary.json",
    "release_scope_summary.md",
    "release_boundary_digest.json",
    "release_boundary_digest.md",
    "release_evidence_pack_index.json",
    "release_evidence_pack_index.md",
    "release_validation_manifest.json",
    "release_validation_manifest.md",
    "audit_readiness_digest.json",
    "audit_readiness_digest.md",
    "pt_ilc_registry.json",
    "pt_ilc_registry.md",
    "external_comparison_importer.json",
    "external_comparison_importer.md",
    "comparison_evidence_pack.json",
    "comparison_evidence_pack.md",
    "scope_comparison_view.json",
    "scope_comparison_view.md",
    "comparison_digest.json",
    "comparison_digest.md",
