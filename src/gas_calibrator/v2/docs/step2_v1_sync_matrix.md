...
| logging/export taxonomy parity | `src/gas_calibrator/logging_utils.py` | partially synced | safe to extend | `src/gas_calibrator/v2/core/result_store.py`, `src/gas_calibrator/v2/core/offline_artifacts.py`, `src/gas_calibrator/v2/adapters/results_gateway.py`, `src/gas_calibrator/v2/ui_v2/controllers/app_facade.py`, `src/gas_calibrator/v2/ui_v2/pages/reports_page.py` | `tests/v2/test_result_store.py`, `tests/v2/test_results_gateway.py`, `tests/v2/test_ui_v2_app_facade.py`, `tests/v2/test_ui_v2_results_page.py`, `tests/v2/test_ui_v2_device_workbench.py` | Sync the field taxonomy only: pressure mode/label, post-seal metrics, stale gauge metrics, flush-gate metrics. Do not copy the V1 logger implementation. |
