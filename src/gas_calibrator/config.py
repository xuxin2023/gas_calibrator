...
_RUNTIME_DEFAULTS: Dict[str, Any] = {
    "workflow": {
        ...
        "analyzer_live_snapshot": {
            ...
            "interval_s": 5.0,
            "cache_ttl_s": 2.5,
            "refresh_during_temperature_target_wait": False,
            ...
            "active_frame_recovery_wait_s": 1.2,
            "active_frame_recovery_poll_s": 0.05,
        ...
        "stability": {
            ...
            "gas_route_dewpoint_gate_max_total_wait_s": 1800.0,
            "water_route_dewpoint_gate_max_total_wait_s": 1800.0,
            ...
            "gas_route_dewpoint_gate_deep_dry_tail_relax_margin_c": 4.0,
