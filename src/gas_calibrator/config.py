...
_RUNTIME_DEFAULTS: Dict[str, Any] = {
    "workflow": {
        ...
        "pressure": {
            ...
            "co2_postseal_physical_qc_enabled": False,
            "co2_postseal_physical_qc_max_abs_delta_c": 1.0,
            "co2_postseal_physical_qc_policy": "off",
            ...
            "co2_postsample_late_rebound_guard_enabled": False,
            "co2_postsample_late_rebound_max_rise_c": 0.12,
            "co2_postsample_late_rebound_policy": "off",
            "co2_sampling_window_qc_enabled": False,
            ...
            "co2_sampling_window_qc_policy": "off",
            ...
            "preseal_trigger_overshoot_warn_hpa": None,
