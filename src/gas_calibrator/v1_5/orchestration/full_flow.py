...
def build_full_flow_plan(
    *,
    ...
    authoritative_resume_offline_state_advance_next_step_plan_dir = (
        root / "authoritative_resume_offline_state_advance_next_step_plan"
    )
    authoritative_resume_offline_state_advance_next_step_authorization_preflight_dir = (
        root / "authoritative_resume_offline_state_advance_next_step_authorization_preflight"
    )
    ...
    steps.append(
        FullFlowStep(
            step_id="formal_initialization_readonly_com_preflight_controlled_executor_design_snapshot",
            title="Review controlled read-only initialization COM preflight executor design",
            phase="INITIALIZATION_READONLY_COM_PREFLIGHT_CONTROLLED_EXECUTOR_DESIGN",
            tool_module=(
            ...
            required_inputs=("formal initialization read-only COM preflight blocked executor JSON",),
            expected_outputs=(
                ...
                "formal_initialization_readonly_com_preflight_controlled_executor_design/V1_5_FORMAL_INITIALIZATION_READONLY_COM_PREFLIGHT_CONTROLLED_EXECUTOR_DESIGN.md",
                "formal_initialization_readonly_com_preflight_controlled_executor_design/v1_5_formal_initialization_readonly_com_preflight_controlled_executor_authorization_contract.csv",
                "formal_initialization_readonly_com_preflight_controlled_executor_design/v1_5_formal_initialization_readonly_com_preflight_controlled_executor_port_inventory_contract.csv",
                "formal_initialization_readonly_com_preflight_controlled_executor_design/v1_5_formal_initialization_readonly_com_preflight_controlled_executor_read_sequence_contract.csv",
                "formal_initialization_readonly_com_preflight_controlled_executor_design/v1_5_formal_initialization_readonly_com_preflight_controlled_executor_evidence_contract.csv",
                "formal_initialization_readonly_com_preflight_controlled_executor_design/v1_5_formal_initialization_readonly_com_preflight_controlled_executor_hold_contract.csv",
                "formal_initialization_readonly_com_preflight_controlled_executor_design/v1_5_formal_initialization_readonly_com_preflight_controlled_executor_boundary_gates.csv",
            ),
            physical_meaning=(
                "Freeze the future controlled read-only COM preflight executor contract after the blocked stub: "
                "explicit read-only COM authorization, reviewed ports, >=1s pacing, identity/SN/GETCO/CHECK reads, "
                "and hold evidence without opening COM."
            ),
            execution_mode="offline_sidecar",
            gate="required_before_readonly_real_com_preflight_live_review",
            notes=(
    ...
    steps.append(
        FullFlowStep(
            step_id="formal_readonly_com_execution_contract_snapshot",
            title="Export controlled read-only COM execution packet contract",
            phase="FORMAL_READONLY_COM_EXECUTION_CONTRACT",
            tool_module="gas_calibrator.tools.export_v1_5_formal_readonly_com_execution_contract",
            command=_python_module(
                ...
                "--output-dir",
                formal_readonly_com_execution_contract_dir,
                "--fail-on-review-required",
            ),
            required_inputs=("controlled read-only COM preflight blocked executor JSON",),
            expected_outputs=(
                "formal_readonly_com_execution_contract/v1_5_formal_readonly_com_execution_contract.json",
                "formal_readonly_com_execution_contract/V1_5_FORMAL_READONLY_COM_EXECUTION_CONTRACT.md",
                "formal_readonly_com_execution_contract/v1_5_formal_readonly_com_execution_packet_contract.csv",
                "formal_readonly_com_execution_contract/v1_5_formal_readonly_com_denied_action_contract.csv",
                "formal_readonly_com_execution_contract/v1_5_formal_readonly_com_future_read_sequence_contract.csv",
            ),
            physical_meaning=(
                "Freeze the future execution packet contract for authorized read-only COM identity/GETCO/CHECK "
                "preflight. This artifact defines required authorization, reviewed port inventory, active analyzer "
                "list, serial pacing, and denied write/route/database actions without opening COM."
            ),
            execution_mode="offline_sidecar",
            gate="required_before_future_readonly_real_com_executor_review",
            notes=(
    ...
    steps.append(
        FullFlowStep(
            step_id="formal_readonly_com_execution_packet_validator_snapshot",
            title="Validate future read-only COM execution packet inputs offline",
            phase="FORMAL_READONLY_COM_EXECUTION_PACKET_VALIDATOR",
            tool_module="gas_calibrator.tools.export_v1_5_formal_readonly_com_execution_packet_validator",
            command=_python_module(
            ...
            required_inputs=("read-only COM execution blocked executor sidecar",),
            expected_outputs=(
                "formal_readonly_com_execution_packet_validator/v1_5_formal_readonly_com_execution_packet_validator.json",
                "formal_readonly_com_execution_packet_validator/V1_5_FORMAL_READONLY_COM_EXECUTION_PACKET_VALIDATOR.md",
                "formal_readonly_com_execution_packet_validator/v1_5_formal_readonly_com_execution_packet_validator_checks.csv",
                "formal_readonly_com_execution_packet_validator/v1_5_formal_readonly_com_execution_packet_validator_summary.csv",
            ),
            physical_meaning=(
                "Validate the future real read-only COM execution packet shape without opening COM: "
                "authorization, reviewed port inventory, active analyzer list, >=1s pacing, SN/device_code, "
                "new-algorithm CHECK requirement, old-algorithm CHECK skip, and no-write/no-route/no-database boundaries."
            ),
            execution_mode="offline_sidecar",
            gate="required_before_future_readonly_real_com_executor_implementation",
            notes=(
    ...
    steps.append(
        FullFlowStep(
            step_id="formal_readonly_com_minimal_executor_review_snapshot",
            title="Review minimal read-only COM executor output and hold contract without COM",
            phase="FORMAL_READONLY_COM_MINIMAL_EXECUTOR_REVIEW",
            tool_module="gas_calibrator.tools.export_v1_5_formal_readonly_com_minimal_executor_review",
            command=_python_module(
            ...
            required_inputs=("read-only COM execution plan preview sidecar",),
            expected_outputs=(
                "formal_readonly_com_minimal_executor_review/v1_5_formal_readonly_com_minimal_executor_review.json",
                "formal_readonly_com_minimal_executor_review/V1_5_FORMAL_READONLY_COM_MINIMAL_EXECUTOR_REVIEW.md",
                "formal_readonly_com_minimal_executor_review/v1_5_formal_readonly_com_minimal_executor_review_checks.csv",
                "formal_readonly_com_minimal_executor_review/v1_5_formal_readonly_com_minimal_executor_output_contract.csv",
                "formal_readonly_com_minimal_executor_review/v1_5_formal_readonly_com_minimal_executor_hold_matrix.csv",
                "formal_readonly_com_minimal_executor_review/v1_5_formal_readonly_com_minimal_executor_review_summary.csv",
            ),
            physical_meaning=(
                "Freeze the minimum implementation contract for a future real read-only COM executor: "
                "required output evidence, per-command raw response traces, hold events, identity/GETCO "
                "snapshots, >=1s pacing, old-algorithm CHECK skip, and no write/database/route side effects. "
                "This sidecar still does not open COM or execute the plan."
            ),
            execution_mode="offline_sidecar",
            gate="required_before_future_minimal_readonly_real_com_executor_implementation",
            notes=(
    ...
    steps.append(
        FullFlowStep(
            ...
            command=_python_module(
                ...
                fit_quality_dir / "v1_5_fit_input_quality_summary.csv",
                "--fit-input-quality-devices-csv",
                fit_quality_dir / "v1_5_fit_input_quality_devices.csv",
            ...
            notes=(
                ...
                "Candidate coefficient commands must consume the fit-input summary and per-device grades generated by the preceding gate.",
