...
class ScrollablePageFrame(ttk.Frame):
    """V1.5 reusable page scaffold with mouse-wheel aware vertical scrolling."""
    ...
    def _update_scroll_region(self) -> None:
        # This method is called from ``<Configure>`` handlers.  Re-entering
        # Tk's idle queue here can recursively trigger every stacked page's
        # configure handler and keep an otherwise hidden shell busy forever.
        # The configure event already means requested geometry is current
        # enough for ``bbox``/overflow reconciliation.
