...
WORKFLOW_TUNABLE_PARAMETERS: Tuple[TunableParameterSpec, ...] = (
    ...
    TunableParameterSpec("pressure", "workflow.pressure.superambient_precharge_enabled", "Superambient precharge enabled", "bool", False),
    ...
    TunableParameterSpec("pressure", "workflow.pressure.co2_post_isolation_diagnostic_enabled", "Low-pressure post-isolation diagnostic", "bool", False),
    ...
    TunableParameterSpec("pressure", "workflow.pressure.pace_upstream_check_valve_installed", "PACE upstream check valve installed", "bool", True),
    TunableParameterSpec("pressure", "workflow.pressure.post_isolation_pressure_truth_source", "Post-isolation pressure truth source", "enum", "external_gauge"),
    TunableParameterSpec("pressure", "workflow.pressure.post_isolation_fast_capture_enabled", "Post-isolation fast capture", "bool", False),
    ...
    TunableParameterSpec("pressure", "workflow.pressure.fast_smoke_capture_min_s", "Check-valve fast smoke minimum capture window", "s", 5.0, 1.0, 20.0),
    TunableParameterSpec("pressure", "workflow.pressure.fast_smoke_capture_no_extended_fallback", "Disable extended fallback for check-valve fast smoke", "bool", True),
    ...
    TunableParameterSpec("pressure", "workflow.pressure.fast_smoke_pressure_drift_max_hpa", "Check-valve fast smoke pressure drift max", "hPa", 0.18, 0.0, 5.0),
    TunableParameterSpec("pressure", "workflow.pressure.fast_smoke_pressure_slope_max_hpa_s", "Check-valve fast smoke pressure slope max", "hPa/s", 0.05, 0.0, 1.0),
    TunableParameterSpec("pressure", "workflow.pressure.fast_smoke_dewpoint_rise_max_c", "Check-valve fast smoke dewpoint rise max", "C", 0.06, 0.0, 5.0),
    ...
    TunableParameterSpec("pressure", "workflow.pressure.low_pressure_same_gas_use_linear_slew", "Use linear slew for low-pressure same-gas", "bool", True),
    TunableParameterSpec("pressure", "workflow.pressure.low_pressure_same_gas_overshoot_allowed", "Allow overshoot for low-pressure same-gas", "bool", False),
    ...
    TunableParameterSpec("temperature", "workflow.stability.temperature.analyzer_check_after_chamber_temp_stable_enabled", "Analyzer CHECK monitor after chamber-temp stable", "bool", True),
    TunableParameterSpec("temperature", "workflow.stability.temperature.analyzer_check_after_chamber_temp_stable_strict", "Analyzer CHECK monitor strict gate", "bool", False),
    TunableParameterSpec("temperature", "workflow.stability.temperature.analyzer_check_command_gap_s", "Analyzer CHECK command gap", "s", 1.0, 1.0, 10.0),
