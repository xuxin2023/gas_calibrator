...
WORKFLOW_TUNABLE_PARAMETERS: Tuple[TunableParameterSpec, ...] = (
    ...
    TunableParameterSpec("sensor", "workflow.stability.sensor.co2_ratio_f_preseal_tol", "CO2 preseal tolerance", "ratio", 0.001, 0.0001, 0.1),
    TunableParameterSpec("sensor", "workflow.stability.sensor.co2_ratio_f_preseal_a_grade_tol", "CO2 preseal A-grade target", "ratio", 0.0005, 0.0001, 0.01),
    ...
    TunableParameterSpec("sensor", "workflow.stability.sensor.h2o_ratio_f_preseal_tol", "H2O preseal tolerance", "ratio", 0.001, 0.0001, 0.1),
    TunableParameterSpec("sensor", "workflow.stability.sensor.h2o_ratio_f_preseal_a_grade_tol", "H2O preseal A-grade target", "ratio", 0.0005, 0.0001, 0.01),
