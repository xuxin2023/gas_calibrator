    ...
    def _build_point_summary_row(
        ...
        *,
        ...
        row = {
            ...
            "co2_calibration_candidate_status": runtime_state.get("co2_calibration_candidate_status"),
            ...
            "co2_calibration_weight_reason": runtime_state.get("co2_calibration_weight_reason"),
            "co2_calibration_reason_chain": runtime_state.get("co2_calibration_reason_chain"),
