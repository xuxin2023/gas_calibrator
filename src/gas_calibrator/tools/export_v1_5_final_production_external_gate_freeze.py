"""Export the final V1.5 real-production external-gate freeze."""
...
from ..validation.v1_5_final_production_external_gate_freeze import (
...
def _parse_args(argv: Optional[Iterable[str]] = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Freeze completed V1.5 program capabilities and remaining real-production external gates."
    )
