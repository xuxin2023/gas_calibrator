"""Export offline V1.5 CO2 S1/S3 model-structure review artifacts."""
...
def _parse_args(argv: Optional[Iterable[str]] = None) -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help="Comma-separated structure ids.",
    )
    parser.add_argument(
        "--objectives",
    ...
    parser.add_argument(
        ...
        help="Comma-separated estimated zero-gas CO2 offsets for sensitivity review.",
    )
...
def main(argv: Optional[Iterable[str]] = None) -> int:
    ...
    print(f"CO2 S1/S3 model-structure review saved: {outputs['markdown']}", flush=True)
    return 0
