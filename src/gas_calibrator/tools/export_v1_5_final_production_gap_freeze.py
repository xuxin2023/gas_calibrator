"""Export the offline V1.5 final production-gap freeze."""
...
from ..validation.v1_5_final_production_gap_freeze import write_v1_5_final_production_gap_freeze


def _parse_args(argv: Optional[Iterable[str]] = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Freeze the remaining V1.5 production gaps without opening COM, writing, routing, or importing."
    )
