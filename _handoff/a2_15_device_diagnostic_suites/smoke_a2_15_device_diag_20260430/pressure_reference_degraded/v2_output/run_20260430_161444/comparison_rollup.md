...
- summary: external comparison rows 2 | types ILC 1 | PT 1 | scope run_20260430_161444-step2-scope-package | decision rule step2_readiness_reviewer_rule_v1 | local-file-only | reviewer-only
- external comparison rows 2 | types ILC 1 | PT 1 | scope run_20260430_161444-step2-scope-package | decision rule step2_readiness_reviewer_rule_v1 | local-file-only | reviewer-only
...
- rollup_id: run_20260430_161444-comparison-rollup
