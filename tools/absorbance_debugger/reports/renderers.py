...
def render_report_markdown(report: Mapping[str, object]) -> str:
    ...
    lines.append("")
    lines.append("## 7. Absorbance model selection")
    ...
    lines.append("")
    lines.append("## 8. Why New Chain Loses")
    ...
    lines.append("")
    lines.append("## 9. Old vs new comparison")
    ...
    if report["comparison_conclusions"]:
        ...
        for item in report["comparison_conclusions"]:
            lines.append(f"- {item}")
    lines.append("")
    lines.append("## 10. Automatic conclusion page")
    lines.append(_table_to_markdown(report["auto_conclusions"], max_rows=10))
    lines.append("")
    lines.append("## 11. Base/final mode")
    ...
    for item in report["limitations"]:
        lines.append(f"- {item}")
    lines.append("")
    lines.append("## 13. Suggested next experiments")
