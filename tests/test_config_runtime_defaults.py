...
def test_load_config_injects_minimal_runtime_defaults_for_new_fields(tmp_path: Path) -> None:
    ...
    assert cfg["workflow"]["humidity_generator"]["safe_stop_timeout_s"] == 5.0
    ...
    assert cfg["workflow"]["pressure"]["co2_presample_long_guard_timeout_s"] == 20.0
    assert cfg["workflow"]["pressure"]["co2_presample_long_guard_max_span_c"] == 0.15
