...
```powershell
python run_v1_co2_calibration_candidate_pack.py --run-dir <completed_run_dir> --output-dir <pack_output_dir>
```

```powershell
python run_v1_co2_weighted_fit_advisory.py --candidate-pack-json <candidate_pack_json> --output-dir <fit_output_dir>
```
...
```powershell
python run_v1_co2_release_readiness_bundle.py --run-dir <completed_run_dir> --output-dir <release_readiness_output_dir>
```

```powershell
python run_v1_co2_fit_evidence_coverage_bundle.py --run-dir <completed_run_dir> --output-dir <fit_evidence_coverage_output_dir>
```
