...
|---|---|---|---:|---|---|---|
| `legacy_v2_source_tree` | `legacy_reference_only` | `exclude_from_v1_5_active_surface` | 1096 | `src/gas_calibrator/v2` | V1.5 is the final production direction; V2 source stays as archived reference unless explicitly revived. | `src/gas_calibrator/v2/adapters/__init__.py`<br>`src/gas_calibrator/v2/adapters/analyzer_coefficient_downloader.py`<br>`src/gas_calibrator/v2/adapters/legacy_runner.py`<br>`src/gas_calibrator/v2/adapters/v1_route_trace.py`<br>`src/gas_calibrator/v2/algorithms/__init__.py`<br>`src/gas_calibrator/v2/algorithms/amt.py`<br>`src/gas_calibrator/v2/algorithms/base.py`<br>`src/gas_calibrator/v2/algorithms/engine.py` |
| `legacy_v2_tests` | `legacy_reference_only` | `exclude_from_v1_5_active_surface` | 173 | `tests/v2` | V2 tests protect old simulation/replay work only; they are not V1.5 formal-flow gates. | `tests/v2/fixtures/real_measurement_frames/run_20260320_043540/fixture_manifest.json`<br>`tests/v2/fixtures/real_measurement_frames/run_20260320_043540/points.csv`<br>`tests/v2/fixtures/real_measurement_frames/run_20260320_043540/samples_runtime.csv`<br>`tests/v2/fixtures/replay/co2_only_skip0_success_single_temp.json`<br>`tests/v2/fixtures/replay/co2_route_entered_but_sample_count_mismatch.json`<br>`tests/v2/fixtures/replay/co2_route_entered_sample_mismatch.json`<br>`tests/v2/fixtures/replay/compare_generates_partial_artifacts_on_failure.json`<br>`tests/v2/fixtures/replay/full_route_success_all_temps_all_sources.json` |
| `legacy_v2_docs` | `legacy_reference_only` | `exclude_from_v1_5_active_surface` | 4 | `docs/architecture/*v2*` | V2 cutover/replay documents are historical context and must not steer V1.5 formal operations. | `docs/architecture/ADR_V1_5_NATIVE_CORE_V2_PLATFORM_20260723.md`<br>`docs/architecture/v1_to_v2_behavior_contract.md`<br>`docs/architecture/v2_cutover_checklist.md`<br>`docs/architecture/V2_EXPERT_CALIBRATION_AND_PRODUCT_AUDIT_20260727.md` |
| `legacy_v1_reference_tools` | `legacy_reference_only` | `do_not_start_v1_5_here` | 3 | `src/gas_calibrator/tools/run_v1_*` | Old V1 write/acceptance tools may preserve algorithm history but must not launch V1.5. | `src/gas_calibrator/tools/run_v1_corrected_autodelivery.py`<br>`src/gas_calibrator/tools/run_v1_merged_calibration_sidecar.py`<br>`src/gas_calibrator/tools/run_v1_online_acceptance.py` |
